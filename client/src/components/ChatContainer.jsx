...
const ChatContainer = ({ showChat, setShowChat }) => {
  ...
  return (
    <Container>
      ...
      <Chat>
        <RecievedMessage>
          hola fghtdfhhhhhhhhhhhhhhhh trw twr twrtrw44t rwerewty
          rewyetryetyetyetryery ertyetyertyertyetry e5ty5et444444444444y
          5y54ey5yy y53y5e4ye45
        </RecievedMessage>
        <Time message="recieved">
          <b>Today at 12:40</b>{" "}
