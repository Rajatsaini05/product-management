...
const UpdateTeam = ({ openUpdate, setOpenUpdate }) => {
  ...
  const [inputs, setInputs] = useState({
    ...
    img: openUpdate.data.img,
    name: openUpdate.data.name,
    desc: openUpdate.data.desc,
    tags: openUpdate.data.tags,
    tools: openUpdate.data.tools,
    members: openUpdate.data.members,
  });
  ...
  return (
    <Modal
      open={true}
      onClose={() => setOpenUpdate({ ...openUpdate, state: false })}
    >
      <Container>
        <Wrapper>
          <IconButton
                ...
                <UsersList>
                  {inputs.members.map((user) => (
                    <MemberCard>
                      ...
                      >
                        <InviteButton
                          onClick={() => updateteamMembers(user, inputs.id)}
                        >
                          {Loading ? (
                            <CircularProgress color="inherit" size={20} />
                          ) : (
                        ...
                        <InviteButton
                          onClick={() => removeteamMembers(user, inputs.id)}
                        >
                          {Loading ? (
                            <CircularProgress color="inherit" size={20} />
                          ) : (
