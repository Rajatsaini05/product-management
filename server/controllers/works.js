    ...
    if (project.members[i].id === req.user.id) {
      if (
        ...
        const mailOptions = {
          ...
          text: `Hi ${req.body.name}, you have been invited to join project ${project.title} by ${user.name}. Please click on the link to join the project. http://localhost:8000/api/project/invite/${req.params.id}/${req.body.id}`,
        };
